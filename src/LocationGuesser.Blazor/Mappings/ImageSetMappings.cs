...
public static class ImageSetMappings
{
    ...
    {
        return new ImageSet(contract.Slug, contract.Title, contract.Description, contract.Tags, contract.LowerYearRange,
            contract.UpperYearRange, contract.ImageCount);
    }
}